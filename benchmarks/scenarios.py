...
SCENARIOS: Final = (
    ...
    _spec("core.invalid_state", "core", {"exception": "MutationInputError", "message": "unsupported schema_version: 2"}),
    ...
    _spec("adapters.synthetic_allow_mapping", "adapters", {"classification": "SYNTHETIC_ONLY_UNREACHABLE_IN_PRODUCTION", "claude_silent": True, "codex_silent": True}),
...
V1_ACCEPTANCE_BLOCKERS: Final = (
    {
        "id": "VAB-1",
        "title": "adapter-path normal-edit ALLOW unreachable",
        "status": "OPEN",
    },
    {
        "id": "VAB-2",
        "title": "automatic unsupported-architecture-mutation blocking unreachable",
        "status": "OPEN",
    },
)
